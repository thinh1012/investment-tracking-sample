    ...
    return (
        <NotificationContext.Provider value={{ notifications, addNotification, removeNotification, notify }}>
            ...
            <div className="fixed bottom-4 right-4 z-50 flex flex-col gap-2 max-w-sm w-full pointer-events-none">
              ...
              ${notification.type === 'warning' ? 'bg-white dark:bg-slate-900 border-indigo-200 dark:border-indigo-800 text-slate-800 dark:text-slate-100' : ''}
            ...
            `}
              ...
              ${notification.type === 'warning' ? 'text-indigo-500' : ''}
