...
export const BackupToast: React.FC<BackupToastProps> = ({
    ...
    return (
        <div className="fixed bottom-6 right-6 flex flex-col gap-4 z-50">
            ...
            {showCleanupReminder && (
                <div className="bg-slate-900 border border-indigo-500/30 text-white p-4 rounded-xl shadow-2xl flex items-start gap-4 max-w-sm animate-in slide-in-from-right duration-500 delay-150">
                    <div className="p-2 bg-indigo-500/10 rounded-lg shrink-0">
                        <Trash2 className="text-indigo-400" size={24} />
                    </div>
                    <div className="flex-1">
                        <h4 className="font-semibold text-indigo-400">Cleanup Reminder</h4>
