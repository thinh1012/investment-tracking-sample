...
import { deriveOpenPrice, ChartPoint, formatPrice } from '../../../services/PriceService';
...
export const MarketPickRow: React.FC<Props> = ({
    pick, price, change, volume, openPrice, sparkline, locale,
    editingOpen, onEditOpen, onSaveOpen, onCancelEdit, onRemove, onSimulate, priceSource
}) => {
