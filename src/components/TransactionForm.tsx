...
const TransactionForm: React.FC<Props> = (props) => {
    ...
    return createPortal(
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6">
            ...
            <div className="relative bg-white dark:bg-slate-900 rounded-xl shadow-2xl w-full max-w-lg overflow-hidden flex flex-col max-h-[90vh]">
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6 overflow-y-auto custom-scrollbar">
                    ...
                    <AdditionalFields
                        ...
                        assets={props.assets}
                        // SELL transaction props
                        paymentCurrency={paymentCurrency}
                        setPaymentCurrency={setPaymentCurrency}
                        receivedAmount={totalSpent}
                        setReceivedAmount={setTotalSpent}
                    />
                    ...
                    <div className="pt-2">
                        <button
                            type="submit"
                            className="w-full bg-indigo-600 text-white py-3 rounded-lg font-medium hover:bg-indigo-700 active:bg-indigo-800 transition-colors"
                        >
