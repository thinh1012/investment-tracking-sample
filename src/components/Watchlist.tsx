...
const Watchlist: React.FC<Props> = ({
    prices = {}, onRefreshPrices, alerts = [], onAddAlert, onRemoveAlert, onToggleAlert, isMuted, onToggleMute, assets = [], onAddTransaction,
    ...
    startEditing, cancelEditing, saveEditing, manualPriceSources = {}
}) => {
